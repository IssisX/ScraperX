...
# fresh world.
const START_NAMES := ["GROUND", "22 M DECK", "44 M DECK", "154 M DECK", "220 M RING", "340 M PLATE",
	"374 M RING", "418 M CAGE", "484 M RING", "528 M CRANE CAGE", "572 M WINCH CAB"]
const START_SPAWNS := [-1, 25, 26, 11, 16, 19, 20, 21, 22, 23, 24]
