...
2. **Close the first +8 m receiver on paper and in a bounded test layout.** Use the Atlas balance-bridge candidate, beginning with the landing, grade approach and walkable rotating deck. Derive release effort, pipe capture, full energy/inertia, finite stop and recovery. Do not build a pipe avalanche before the downstream geometry can accept it. This is proposed next work, not implicitly opened by the reset.
