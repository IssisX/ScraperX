...
| Current delivery | New pipe-bridge code candidate is pending exact-SHA CI and APK verification. The local ARM64 full legacy suite reaches the pre-existing AS-002 mid-landing failure; an untouched `4cdb2bc` reconstruction fails identically. The required workflow gate is retained. |
