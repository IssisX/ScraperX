...
| **Design doctrine** | `03_EXECUTION/PLANNING/CAUSAL_ASCENT_DOCTRINE.md`. A lift is a real energy chain: stored energy, a restraint, a physical trigger, a load path, governed motion, a place for the leftover energy, a real catch, then a physical handoff. The 280 m to 680 m stages in that file are a design, not built machines. It does not freeze work onto one cage. |
